    ...
    <TableWrapper>
      <table>
        ...
        <td colSpan={2}>Basic Information on Data Protection</td>
          ...
          <tr>
            <td>Responsible</td>
            <td>The personal data that is collected directly from the applicant for the voting processes will be treated confidentially and will be incorporated into the corresponding treatment activity owned by Aragon.</td>
          </tr>
          <tr>
            <td>Purpose</td>
          ...
          <tr>
            <td>Legitimation</td>
            <td> <p>
            The legal basis for the treatment in relation to sending information, assistance Advertising and advertising on Aragon products and services is the consent referred to in article 6.1.a) GDRP, and article 7 of the GDRP.
              </p>
            </td>
          </tr>
          <tr>
