    ...
    <PageCard>
      <>
        ...
        <>
          ...
          <p>Los datos de carácter personal que se pudieran recabar directamente del interesado serán tratados de forma confidencial y quedarán incorporados a la correspondiente actividad de tratamiento titularidad de Aragon.</p>
          <p></p>
          <p>La relación actualizada de las actividades de tratamiento que Aragon lleva a cabo se encuentra disponible en el siguiente enlace al registro de actividades de Aragon: <a target="_blank" href={REGSITRY_PATH}>https://vocdoni.app{REGSITRY_PATH}</a></p>
<p></p>
            <h4>¿Quién es el Responsable del tratamiento de sus datos?</h4>
            <p>Identidad: Aragon, AG</p>
            <p>CIF:  CH-170.3.045.491-2</p>
            <p>Dir. postal: Bahnhofstrasse, 20, 6300 Zug, Switzerland</p>
            <p>Teléfono: +372 54680950</p>
            <p>Correo electrónico: privacy@aragon.org</p>
            <p>Contacto DPD: <a href="mailto:roger@aragon.org">Roger
            Baig</a></p>
            <p></p>
            <h4>Finalidad</h4>
            <p>La finalidad del tratamiento de los datos corresponde a cada una de las actividades de tratamiento que realiza Aragon, accesibles en el correspondiente registro de actividades de tratamiento a que se refiere el enlace indicado en el párrafo anterior.</p>
            <p></p>
            <h4>Legitimación</h4>
            <p></p>
            <p>El tratamiento de sus datos se realiza para el cumplimiento de obligaciones legales por parte de Aragon.</p>
            <p></p>
            ...
            <p></p>
            <p>Puede consultar la base legal para cada una de las actividades de tratamiento que lleva a cabo Aragon en el enlace al registro de actividades de Aragon indicado previamente. </p>
            <p></p>
            ...
            <p></p>
            <p>Puede consultar los destinatarios para cada una de las actividades de tratamiento que lleva a cabo Aragon en el enlace al registro de actividades de Aragon.</p>
            <p></p>
            <h4>Derechos de los interesados</h4>
            <p>Cualquier persona tiene derecho a obtener confirmación sobre los tratamientos que de sus datos que se llevan a cabo por Aragon.</p>
            <p>YPuede ejercer sus derechos de acceso, rectificación, supresión y portabilidad de sus datos, de limitación y oposición a su tratamiento, así como a no ser objeto de decisiones basadas únicamente en el tratamiento automatizado de sus datos, cuando procedan, ante Aragon, Calle Bahnhofstrasse 20, 6300 Zug,
        Switzerland, o en la dirección de correo electrónico</p>
            ...
            <p>Las medidas de seguridad implantadas se encuentran descritas en los documentos que conforman la documentación de Política de Seguridad de Aragon en relación al concreto servicio.</p>
            <p></p>
            <h4>¿Se toman decisiones automatizadas?</h4>
            <p>Aragon no adopta decisiones automatizadas, ni siquiera la elaboración de perfiles.</p>
            <p></p>
            <h4>¿Se realizan transferencias internacionales de datos?</h4>
            <p>Aragon no realiza transferencias de datos personales a terceros países a los que no es de aplicación el RGPD.</p>
            <p></p>
        ...
        <When condition={lang === 'en'}>
          ...
          treated confidentially and will be incorporated into the corresponding treatment activity owned by Aragon.</p>
          <p></p>
          <p>The updated list of the treatment activities that Aragon carries out is available at the
          following link to the Aragon activity register: <a target="_blank" href={REGSITRY_PATH}>https://vocdoni.app{REGSITRY_PATH}</a></p>
<p></p>
            <h4>Who is responsible for the processing of your data?</h4>
            <p>Identity: Aragon, AG</p>
            ...
            <p>Email: privacy@aragon.org</p>
            <p>DPD Contact: <a href="mailto:roger@aragon.org">Roger Baig</a></p>
            <p></p>
            <h4>Purpose</h4>
            <p>The purpose of data processing corresponds to each of the processing activities carried
            out by Aragon, accessible in the corresponding record of processing activities referred to in the link
        ...
        Aragon.</p>
            ...
            for
            the voting process is based on the legitimate interest of Aragon. The sending of information, advertising,
        ...
        Aragon in the link to the Aragon activity register indicated previously. </p>
            <p></p>
        ...
        as long as the contractual relationship is in force.</p>
            ...
            actions in the administrative and judicial channels. In all cases, once the service is finished, Aragon
            will
        ...
        Aragon in the link to the Aragon activity register.</p>
            <p></p>
        ...
        carried out by Aragon.</p>
            ...
            on
            the automated processing of your data, when appropriate, before Aragon, Bahnhofstrasse 20, 6300 Zug,
        Switzerland, or at the email address privacy@aragon.org</p>
            <p></p>
        ...
        imply the impossibility of providing the service.</p>
            <p></p>
            <h4>Security</h4>
            <p>The Measures implemented are described in the documents that make up the Aragon
        Security Policy documentation in relation to the specific service.</p>
            <p></p>
            <h4>Are automated decisions made?</h4>
            <p>Aragon does not make automated decisions, not even
        profiling.</p>
            <p></p>
            <h4>Are international data transfers made?</h4>
            <p>Aragon does not transfer personal data to third countries to
