          ...
          <RegistryWrapper>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Categorías de destinatarios a quienes se comunicaron o comunicarán los datos personales</td>
                ...
                <tr>
                  <td> Transferencias de datos personales a un tercer país o una organización internacional</td>
                  <td> No están previstas	transferencias internacionales de los datos.</td>
                </tr>
                <tr>
                  <td> 			Plazos previstos para la 			supresión de las diferentes categorías de datos			 		</td>
